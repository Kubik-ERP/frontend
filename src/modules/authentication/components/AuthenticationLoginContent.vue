...
// Components
import AuthenticationLoginForm from './AuthenticationLoginForm.vue';
</script>

<template>
  <section id="authentication-login-content" class="grid-wrapper-fullscreen">
...
<style scoped>
section#authentication-login-content aside#linear-gradient {
