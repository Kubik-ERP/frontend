...
<template>
  <section id="kitchen-invoice" class="invoice-paper bg-white flex flex-col items-center gap-2 w-full p-4 min-w-[58mm] max-w-[100mm] h-fit">
    <div class="invoice-name">
      <span class="font-bold w-full flex justify-center text-[12pt]">{{
        invoice_invoiceData.tableKitchenTicket?.customer?.name || ''
      }}</span>
      <span class="w-full flex justify-center">Table Ticket</span>
    </div>

    <section id="cashier-information" class="flex items-center justify-between w-full border-b border-black py-2">
      <p id="label-cashier" class="font-normal text-black text-[12pt]">Order Date</p>
    ...
    <section id="cashier-information" class="flex items-center justify-between w-full">
      <p id="label-cashier" class="font-normal text-black text-[12pt]">Invoice Number</p>
      <p id="cashier-name" class="font-normal text-black text-[12pt]">
    ...
    <section id="cashier-information" class="flex items-center justify-between w-full">
      <p id="label-cashier" class="font-normal text-black text-[12pt]">Staff</p>
      <p id="cashier-name" class="font-normal text-black text-[12pt]">
    ...
    <section id="cashier-information" class="flex items-center justify-between w-full">
      <p id="label-cashier" class="font-normal text-black text-[12pt]">Order Type</p>
      <p id="cashier-name" class="font-normal text-black text-[12pt]">
        {{
    ...
    <table id="product-items" class="w-full">
      <thead>
        <tr class="border-y border-dashed border-black py-2">
          <th class="font-normal text-black text-[12pt] text-start py-2">Qty</th>
          <th class="font-normal text-black text-[12pt] text-start py-2 whitespace-nowrap">Order Item</th>
        </tr>
      </thead>
      <tbody
