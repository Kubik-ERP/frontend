export const TRANSFER_STOCK_RECEIVE_LIST_COLUMNS: IColumnDataTable[] = [
  {
...
export const TRANSFER_STOCK_RECEIVER_LIST_MOCK_DATA = {
  items: [
    {
      id: 'ts-001',
...
export const TRANSFER_STOCK_RECEIVER_STATUS_CLASSES = {
