...
const generateUrl = computed(() => {
  return `${APP_BASE_URL}/self-order/login?storeId=${outlet_selectedOutletOnAccountPage.value!.id}&floorName=${accountStoreTableConfiguration_formDataOfAddTable.floorName}&tablesName=${accountStoreTableConfiguration_formDataOfAddTable.name}`;
});
