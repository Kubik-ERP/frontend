...
import { useStorageLocationImportService } from '../services/storage-location-import.service';

const {
  storageLocationImport_step,
  storageLocationImport_isLoading,
  storageLocationImport_values,
  ...
  storageLocationImport_columns,
} = useStorageLocationImportService();
</script>
  ...
  >
    ...
    <template #content>
      <div class="h-full sm:h-[400px] flex items-center justify-center border border-grayscale-10">
        <!-- Step 1: Upload -->
        <section
          v-if="storageLocationImport_step === 1"
        ...
        <!-- Step 2: Loading -->
        <section
          v-else-if="storageLocationImport_isLoading"
    ...
    <template #footer>
      <div class="flex justify-end gap-2">
        <PrimeVueButton
          ...
          @click="storageLocationImport_onClose"
        />
        <PrimeVueButton
          label="Import"
