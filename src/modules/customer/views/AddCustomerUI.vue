      ...
      <div class="flex flex-col">
        ...
        <div class="flex flex-wrap gap-4">
          <div class="flex items-center gap-2">
            <PrimeVueRadioButton v-model="customer.gender" input-id="gender1" name="gender" value="Male" />
            <label for="gender1">Male</label>
          </div>
          <div class="flex items-center gap-2">
            <PrimeVueRadioButton v-model="customer.gender" input-id="gender2" name="gender" value="Female" />
