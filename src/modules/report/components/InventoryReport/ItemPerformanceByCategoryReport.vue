...
const formattedDataTable = () => {
  const newData = inventoryReport_itemPerformanceByCategory_values?.value?.map(item => {
    return {
...
const handleExportToPdf = () => {
  exportToPdf({
    reportName: 'Inventory Report - Item Performance By Category Report',
    ...
    columns: inventoryReport_itemPerformanceByCategory_columns,
  ...
  <section>
    ...
    >
      <template #header-prefix>
        <h1 class="font-bold text-2xl text-text-primary">Item Performance By Category Report</h1>
      </template>
      ...
      <template #filter>
        <section class="grid grid-cols-1 xl:grid-cols-2 gap-4 pt-4">
          <CustomDatePicker
            ...
            class=""
            @update:end-date="report_getInventoryReport('item-performance-by-category')"
          />
          <PrimeVueSelect
            ...
            class=""
            filter
            @change="report_getInventoryReport('item-performance-by-category')"
          >
