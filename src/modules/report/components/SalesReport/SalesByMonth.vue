...
const { salesReport_columns, report_queryParams, report_getSalesReport, salesReport_salesByMonth_values, staff_lists_options, outlet_lists_options } =
  useReportService();
      ...
      <template #filter>
        <section class="flex items-center gap-4 pt-4">
          <CustomDatePicker
            ...
            @update:start-date="report_getSalesReport('month')"
          />
          <PrimeVueSelect
