...
import { IMidtransQrisPaymentData } from '@/modules/self-order/interfaces';
...
const handleClose = () => {
  if (route.name === 'invoice' || route.name === 'self-order-invoice') {
...
<template>
  <section id="self-order-summary-modal-payment-qris">
    <PrimeVueDialog
